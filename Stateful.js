...
define([
	 ...
	 * @class module:delite/Stateful~StatefulPropertyListObserver
	 * @property {Object} o The {@link module:delite/Stateful Stateful} being observed.
	 * @property {Object} [names] The list of properties this observer cares about.
	 */
	function StatefulPropertyListObserver(o, names) {
		this.o = o;
		this.names = names || {};
	}

	StatefulPropertyListObserver.prototype = /** @lends module:delite/Stateful~StatefulPropertyListObserver# */ {
		/**
		...
		/**
		 * Add properties to the observed property list.
	...
	/**
	 * Synonym for {@link module:delite/Stateful~StatefulPropertyListObserver#close `close()`}.
	 * @method
	 */
	StatefulPropertyListObserver.prototype.remove = StatefulPropertyListObserver.prototype.close;
	...
	var Stateful = dcl(null, {
		 ...
		 * @returns {module:delite/Stateful~StatefulPropertyListObserver}
		...
		observe: function () {
			...
			var h = new StatefulPropertyListObserver(this, names);
